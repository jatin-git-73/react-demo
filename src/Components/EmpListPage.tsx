    ...
    return <>
            ...
            <Grid container justifyContent='space-between' >
                    ...
                    <div style={{
                        ...
                        <TextField size="small"  defaultValue={search_query} onChange={(e)=>setSearchQuery(e.target.value)} label="Search" variant="outlined" />
                        </div>
                    </Grid>
                    <Grid item md={1}   >
                        <div style={{
                    ...
                    <EmpList search_query={search_query} />
             </Grid>
    </>
}
