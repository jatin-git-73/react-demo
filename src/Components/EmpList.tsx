  ...
  if (props.search_query !== "") {
    list = list.filter(
      (t) =>
        ...
        t.last_name.includes(props.search_query) ||
        t.company_name.includes(props.search_query) ||
        t.designation.includes(props.search_query) ||
            ...
            >
              ...
              <TableCell align="right">
                <Button
                  variant="contained"
                  color="error"
                  onClick={() => props.handleDeleteClick(row.id)}
                >
                  {" "}
                  Delete{" "}
                </Button>
