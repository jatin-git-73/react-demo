...
export function getDefaultErrors(cur_step: number): ValidationError {
  ...
  let default_educational_details_error: {
    failed: boolean;
  ...
  let default_errors = [
    ...
    default_bank_details_errors,
    default_professionalDetails_error,
    default_current_status_error,
    default_experience_error,
    default_educational_details_error,
  ];
